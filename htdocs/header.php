...
<nav class="navbar navbar-expand-lg px-3" style="background: linear-gradient(90deg, rgb(4, 130, 12)0%, rgb(47, 187, 49)35%, rgb(3, 83, 12)100%)">

    <a class="navbar-brand" href="#" style="">
      <img src="images/11.jpg" style="width: 40px;  border-radius:50%; margin: 10px; box-shadow: 3px 4px 5px black">
      
      <b style="color: white">Safari Academy Online Examination System</b>
    </a>
...
<div class="jumbotron jumbotron pb-3 px-2 pt-5">
  <div class="container text-center text-white py-3 px-3 shadow-custom" style="border-radius: 8px; font-size: 20px; background-color: #f80505; width: 200px;border-radius:50%">
...
<div class="jumbotron jumbotron pb-3 px-2">
  <div class="container text-white text-center py-3 px-3 shadow-custom" style="border-radius: 8px; font-size: 20px; background-color: #ec0808;">
    <strong>
    	Instructions:
    </strong> 
    <span>
