...
<div class="container d-flex justify-content-center" >
	...
	<form action="student-registration.php" method="post">		
		<div class="container py-2 px-4 text-white shadow-custom" style="border-radius: 15px; background: linear-gradient(90deg, rgb(4, 130, 12)0%, rgb(47, 187, 49)35%, rgb(3, 83, 12)100%)">

	 		<div class="mt-3 text-center">
	 			<a href="index.php">
				<img src="images/11.jpg" style="width: 75px; width: 75px; border-radius:50%; box-shadow: 3px 4px 5px #000"></a>
				<h3>Sign Up</h3>				
			</div>
