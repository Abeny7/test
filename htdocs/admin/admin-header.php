    ...
    <link rel="icon" type="image/x-icon" href="11.png">
...
<nav class="navbar navbar-expand-lg px-3" style="background-color: #263159">
    ...
    <a class="navbar-brand" href="#" style="background-color: #263159">
      <img src="11.jpg" style="width: 40px; border-radius: 50%; box-shadow: 3px 4px 5px #000">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item text-center">
        <a class="nav-link text-white" href="admin-exam.php">Add Exams</a>
      </li>
