...
<body class="pt-5"  style="background: linear-gradient(90deg, rgb(144, 243, 152)0%, rgb(233, 238, 233)35%, rgb(144, 243, 152)100%);">
...
<div class="container d-flex justify-content-center" >
	...
	<form action="admin-login.php" method="post">
		<div class="container p-4 px-4 text-white text-center shadow-custom" style="border-radius: 15px; background: linear-gradient(90deg, rgb(4, 130, 12)0%, rgb(47, 187, 49)35%, rgb(18, 237, 91)100%)">

	 		<div class="mt-3">
				<a href="index.php">
				<img src="images/11.jpg" 
				class="mx-auto d-block img-fluid my-3" style="width: 75px; border-radius:50%; box-shadow:2px 3px 4px #000;"></a>
